...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const msg = core.getInput('msg', { trimWhitespace: false }) || 'Default message';
            const show_ref = core.getBooleanInput('show_ref') || false;
            const username = core.getInput('username') || 'Github Actions';
            const icon_emoji = core.getInput('icon_emoji') || 'octocat';
            const channelsRaw = core.getInput('channels', { required: true });
      ...
      `);
            ...
            const mm = new mattermost_1.Mattermost(url, username, icon_emoji, show_ref);
